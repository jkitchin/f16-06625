...
* Announcements
** Jupyter notebooks alternative to code blocks
Some people wanted an alternative way to run Python code than in Emacs. A Jupyter notebook is a way to run Python in your web browser and save the results. We can try an experiment using the Jupyter notebook for the Python part of the course, and Emacs for everything else.
...
You can open a notebook by creating and clicking on a link like this:  ipynb:example.ipynb The notebook should launch in a browser; it may take a little time to open the first time. The file will be created in the directory of the file that the link is in.

You still need to use Emacs to read the notes and turn in assignments. I will still show you all examples from Emacs. You can try the notebook for code blocks if you want, but you must put the link to the notebook in your assignment in place of the code block so we know it is there.
...
** [2016-09-12 Mon] [[./rxns-book/rates+rate-laws.org]]

** [2016-09-14 Wed] [[./rxns-book/mole-balance.org]]

** [2016-09-19 Mon] [[./rxns-book/complex-mole-balances.org]]

** [2016-09-21 Wed] [[./rxns-book/transient-cstr-mss.org]]

** [2016-09-26 Mon] [[./rxns-book/misc-reactor-mole-balance.org]]

** [2016-09-28 Wed] [[./rxns-book/wrapping-up-introduction.org]]

** [2016-10-03 Mon] [[./rxns-book/multiple-rxns-1.org]]

** [2016-10-05 Wed] EXAM 1 (will cover material through 9/30)

** [2016-10-10 Mon] [[./rxns-book/multiple-rxns-2.org]]

** [2016-10-12 Wed] [[./rxns-book/parameter-estimation.org]]

** [2016-10-17 Mon] [[./rxns-book/parameter-estimation-2.org]]

** [2016-10-19 Mon] Jake Boes guest lecture

** [2016-10-24 Wed] [[./rxns-book/mechanism-determination.org]]

** [2016-10-26 Wed] [[./rxns-book/engineering-applications.org]]
...
** [2016-11-23 Wed]  [[./rxns-book/non-isothermal-cstr.org]]

** [2016-11-28 Mon] * MRS NO CLASS*
...
** COLLECTED assignment:parabola				 :assignment:
